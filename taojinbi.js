...
function dice_task() {
    ...
    sleep(5000)
    //橙色收下奖励按钮按钮
    cs_click(3, '#ff7d44', 0.2, 0.45, 0.45, 0.2); sleep(2500)
    //金色前进按钮
...
function taojinbi_task() {
    ...
    for (let i = 0; i < 2; i++) {
        ...
        feed_chick_task(); shop_10coin_task()
...
function exchange_red_envelope_task() {
    ...
    btn_click(textContains('免费领取').findOne(1000)); sleep(1000); back()
}

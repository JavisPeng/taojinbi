# taobao_taojinbi
本项目主要用于自动执行淘金币相关活动，用于参与淘金币夺宝活动(可下注抢茅台)

**后续代码持续更新，转载引用请注明出处，你的☆就是我的动力**

# 测试环境
华为P30Pro + [autojs4.1.1](https://share.weiyun.com/owu3tBNr) + [淘宝v9.0.0](https://www.wandoujia.com/apps/32267/history)
 ...
 **单独执行[年货节浇灌福气]：启动程序后下拉找到“单独执行年货节浇灌福气”按钮，点击即可  【请使用淘宝v9.0.0版本，新版有无障碍检测功能】**
 
# 更新日志

**v1.5.3** 2021年1月20日20:46:10
1. 淘宝版本修改为v9.0.0，新版年货节浇灌福气任务，实测10级后升级龟速
